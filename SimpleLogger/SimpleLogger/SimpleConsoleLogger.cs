...
namespace SimpleLogger
{
    ...
    using System.Text;
    using System.Xml;
    using SimpleLogger.ObjectModel;
    using SimpleLogger.Utility;
    ...
    using TrxLoggerConstants = SimpleLogger.Utility.Constants;
    using TrxLoggerObjectModel = SimpleLogger.ObjectModel;
    ...
    internal class SimpleConsoleLogger : ITestLoggerWithParameters
    {
        #region Fields
        ...
        private ITestElement GetOrCreateTestElement(Guid executionId, Guid parentExecutionId, TestType testType, ITestElement parentTestElement, Microsoft.VisualStudio.TestPlatform.ObjectModel.TestResult rockSteadyTestResult)
        {
